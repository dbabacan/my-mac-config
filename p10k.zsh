# Generated by Powerlevel10k configuration wizard on 2021-09-01 at 16:30 PDT.
...
() {
  ...
  function my_git_formatter() {
    ...
    local      derinclean='%1F' # red foreground
    ...
    if [[ -n $VCS_STATUS_LOCAL_BRANCH ]]; then
      ...
      res+="${derinclean}${(g::)POWERLEVEL9K_VCS_BRANCH_ICON}${branch//\%/%%}"
    fi
